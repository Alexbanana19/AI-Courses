...
batch_size = 2000
#==============================================================================
# learn the dynamics to minimize the cost
#==============================================================================
...
y = tf.placeholder(tf.float32, [None, 376], name = 'y_input')
...
with tf.Session(config=config) as sess:
    ...
    for epoch in xrange(50000):
        ...
        if epoch % 500 == 0:
            save_path = saver.save(sess, "/home/minghan/hw1/model/global/global.ckpt")